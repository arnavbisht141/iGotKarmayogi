...
class CarryforwardCompetencyResult(BaseModel):
    competency: str
    score: float
    level: str  # Exemplary, Proficient, Needs Attention
    description: str
...
class CarryforwardSessionSummary(BaseModel):
    ...
    competency_results: List[CarryforwardCompetencyResult] = Field(default_factory=list)
