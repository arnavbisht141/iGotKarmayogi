    ...
    if not val:
        ...
        flag_feedback = mo.callout(
            mo.md(
                ...
                "Your recovered persistence flag is confirmed! Now submit this flag in the **Submit Flag** box in the left portal pane to register your 100 points and Incident Response competency!"
            ),
            kind="success",
        )
